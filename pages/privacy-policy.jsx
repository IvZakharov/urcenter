          ...
          <Grid container justifyContent={"center"}>
            <Grid item xs={12} lg={8}>
              ...
              <Typography sx={materialStyles.text}>
                ...
                информации, которую сайт Юридический центр города Москвы, (далее
                – Юридический центр) расположенный на доменном
                имени https://www.urcentr.su/ (а также его субдоменах), может
                получить о Пользователе во время использования сайта
                https://www.urcentr.su/ (а также его субдоменов), его программ и
                его продуктов.
              </Typography>
              ...
              <Typography sx={materialStyles.text}>
                ...
                уполномоченные сотрудники на управление сайтом Юридический центр
                города Москвы , действующие от имени ИП Ильиной Ирины
                Алексеевны, которые организуют и (или) осуществляют обработку
              ...
              <Typography sx={materialStyles.text}>
                1.1.5. «Сайт Юридический центр города Москвы»  - это
                совокупность связанных между собой веб-страниц, размещенных в
              ...
              <Typography sx={materialStyles.text}>
                ...
                Юридический центр города Москвы, а также другие временные
                страницы, внизу который указана контактная информация
                Администрации.
              </Typography>
              <Typography sx={materialStyles.text}>
                1.1.7. «Пользователь сайта Юридический центр города Москвы  »
                (далее Пользователь) – лицо, имеющее доступ к сайту Юридический
                центр города Москвы, посредством сети Интернет и использующее
                информацию, материалы и продукты сайта  Юридический центр города
                Москвы.
              </Typography>
              <Typography sx={materialStyles.text}>
              ...
              <Typography sx={materialStyles.text}>
                ...
                сети, через который Пользователь получает доступ на Юридический
                центр.
              </Typography>
              <Typography sx={materialStyles.text}>
                1.2.0. «Товар» - продукт, который Пользователь заказывает на
              ...
              <Typography sx={materialStyles.text}>
                2.1. Использование сайта Юридический центр города Москвы
              ...
              <Typography sx={materialStyles.text}>
                ...
                Пользователь должен прекратить использование сайта Юридический
                центр города Москвы .
              </Typography>
              <Typography sx={materialStyles.text}>
                2.3. Настоящая Политика конфиденциальности применяется к сайту
                Юридический центр города Москвы. Юридический центр не
                ...
                сайте Юридический центр города Москвы.
              </Typography>
              <Typography sx={materialStyles.text}>
              ...
              <Typography sx={materialStyles.text}>
                ...
                регистрации на сайте Юридический центр города Москвы, при
              ...
              <Typography sx={materialStyles.text}>
                ...
                Пользователем путём заполнения форм на сайте Юридический центр
                города Москвы и включают в себя следующую информацию:
              </Typography>
              <Typography sx={materialStyles.text}>
              ...
              <Typography sx={materialStyles.text}>
                3.3. Юридический центр защищает Данные, которые автоматически
              ...
              <Typography sx={materialStyles.text}>
                3.3.2. Юридический центр осуществляет сбор статистики об
              ...
              <Typography sx={materialStyles.text}>
                ...
                Юридический центр города Москвы, если Пользователь дал согласие
              ...
              <Typography sx={materialStyles.text}>
                ...
                Юридический центр города Москвы, включая доставку Товара,
              ...
              <Typography sx={materialStyles.text}>
                ...
                Юридический центр города Москвы, и давать согласие на их
                обработку.
              </Typography>
              <Typography sx={materialStyles.text}>
              ...
              <Typography sx={materialStyles.text}>
                ...
                случаев, предусмотренных п.п. 5.2., 5.3. и 7.2. настоящей
              ...
              <Typography sx={materialStyles.text}>
                ...
                сайта Юридический центр города Москвы, несет лицо,
                предоставившее такую информацию.
              </Typography>
              <Typography sx={materialStyles.text}>
                7.5. Пользователь соглашается, что информация, предоставленная
                ему как часть сайта Юридический центр города Москвы, может
                являться объектом интеллектуальной собственности, права на
                который защищены и принадлежат другим Пользователям, партнерам
                или рекламодателям, которые размещают такую информацию на сайте
                Юридический центр города Москвы. Пользователь не вправе вносить
                ...
                собственниками такого Содержания в соответствии с условиями
                отдельного соглашения.
              </Typography>
              <Typography sx={materialStyles.text}>
                7.6. В отношение текстовых материалов (статей, публикаций,
                находящихся в свободном публичном доступе на сайте Юридический
                центр города Москвы) допускается их распространение при условии,
                что будет дана ссылка на Юридический центр.
              </Typography>
              <Typography sx={materialStyles.text}>
                ...
                Юридический центр города Москвы или передаваемых через него.
              </Typography>
              <Typography sx={materialStyles.text}>
              ...
              <Typography sx={materialStyles.text}>
                ...
                информацию, размещенную пользователем на сайте Юридический центр
                города Москвы, включая, но не ограничиваясь: информацию,
              ...
              <Typography sx={materialStyles.text}>
                ...
                ее размещения на сайте Юридический центр города Москвы, если
                иное не предусмотрено новой редакцией Политики
                конфиденциальности.
              </Typography>
              <Typography sx={materialStyles.text}>
                9.3. Все предложения или вопросы касательно настоящей Политики
                конфиденциальности следует сообщать по адресу: info@urcentr.su
              </Typography>
              <Typography sx={materialStyles.text}>
                9.4. Действующая Политика конфиденциальности размещена на
                странице по адресу https://https://www.urcentr.su/privacy-policy
              </Typography>
              <Typography sx={materialStyles.text}>
                Обновлено: 18 Октября 2022 года
              </Typography>
              <Typography sx={materialStyles.text}>
